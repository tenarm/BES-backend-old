...
def _bootstrap_config():
    ...
    CONFIG_PATH = BASE_DIR / "instances" / "msme" / "config" / "onboard_config.json"
    os.environ["ADMIN_PERMISSIONS_PATH"] = str(BASE_DIR / "instances" / "msme" / "config" / "admin_permissions.json")
