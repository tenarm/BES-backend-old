...
def _bootstrap_config():
    ...
    CONFIG_PATH = BASE_DIR / "instances" / "test_pro" / "config" / "onboard_config.json"
    os.environ["ADMIN_PERMISSIONS_PATH"] = str(BASE_DIR / "instances" / "test_pro" / "config" / "admin_permissions.json")
