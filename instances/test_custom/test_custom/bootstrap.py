...
def _bootstrap_config():
    ...
    CONFIG_PATH = BASE_DIR / "instances" / "test_custom" / "config" / "onboard_config.json"
    os.environ["ADMIN_PERMISSIONS_PATH"] = str(BASE_DIR / "instances" / "test_custom" / "config" / "admin_permissions.json")
